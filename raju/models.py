...
class MetrcPlants(models.Model):
    ...
    plant_batch_id = fields.Integer(string='Batch id of the plant', default = 'null')
    plant_batch_name = fields.Char(string='Plant batch name', default = 'null')
    plant_batch_type_name = fields.Char(string='Plant batch type name', default = 'null')
    strain_id = fields.Integer(string='Strain id', default = 'null')
    strain_name = fields.Char(string='Strain name', default = 'null')
    location_id = fields.Integer(string='Location id', default = 'null')
    location_name = fields.Char(sting='Plants Location', default = 'null')
    location_type_name = fields.Char(string='Location type name', default = 'null')
    room_id = fields.Many2one('metrc.rooms', string='Room', required=True)
    room_name = fields.Char(string='Room name', default = 'null')
    patient_license_number = fields.Char(string='Patient license number', default = 'null')
    harvest_id = fields.Integer(string='Room name', default = 'null')
    harvested_unit_of_weight_name = fields.Char(string='Patient license number', default = 'null')
    harvested_unit_of_weight_abbreviation = fields.Char(string='Room name', default = 'null')
    harvested_wet_weight = fields.Float(string='Harvested net weight', default = 'null')
    harvest_count = fields.Integer(string='Harvest Count', default = 'null')
    is_on_hold = fields.Integer(string='is_on_hold', default = 'null')
    planted_date = fields.Date(string='Received date time', default = 'null')
    vegetative_date = fields.Date(string='Received date time', default = 'null')
    flowering_date = fields.Date(string='Received date time', default = 'null')
    harvested_date = fields.Date(string='Received date time', default = 'null')
    destroyed_date = fields.Date(string='Received date time', default = 'null')
    destroyed_note = fields.Date(string='Received date time', default = 'null')
    destroyed_by_user_name = fields.Char(string='Destroyed by User Name', default = 'null')
    last_modified = fields.Datetime(string='Received date time', default = 'null')
